          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 flex flex-col md:flex-row items-center md:items-start gap-10 mb-20">
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Natural de Goiânia, Henrique é <span className="font-bold text-emerald-700">especialista em Direito e Processo Penal</span>, com <span className="font-bold text-emerald-700">MBA em Perícia, Auditoria e Gestão Ambiental</span>. Desde 2006, atua na <span className="font-bold text-emerald-700">área ambiental</span>, inicialmente como <span className="font-bold text-emerald-700">consultor</span>, atendendo produtores rurais, empresas e empreendedores em processos de <span className="font-bold text-emerald-700">licenciamento</span>, <span className="font-bold text-emerald-700">regularização fundiária</span> e <span className="font-bold text-emerald-700">gestão</span> junto a <span className="font-bold text-emerald-700">órgãos ambientais</span>.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                Com ampla <span className="font-bold text-emerald-700">experiência prática e estratégica</span>, integrou sua atuação técnica ao <span className="font-bold text-emerald-700">campo jurídico</span>, oferecendo <span className="font-bold text-emerald-700">soluções completas e sustentáveis</span> no <span className="font-bold text-emerald-700">setor ambiental e do agronegócio</span>. Seu trabalho é pautado pela <span className="font-bold text-emerald-700">ética</span>, <span className="font-bold text-emerald-700">responsabilidade</span> e <span className="font-bold text-emerald-700">compromisso</span> com a <span className="font-bold text-emerald-700">segurança jurídica e ambiental</span> de seus clientes, sempre visando ao <span className="font-bold text-emerald-700">desenvolvimento econômico</span> aliado à <span className="font-bold text-emerald-700">preservação dos recursos naturais</span>.
              </p>
